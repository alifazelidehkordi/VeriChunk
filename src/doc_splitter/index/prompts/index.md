...
1. Call `get_chunk` for every unread chunk ID. Read the content.
...
1. Write two complete standalone Markdown files:
...
Return the final Markdown bodies for both languages, then commit them with
`commit-index`.
